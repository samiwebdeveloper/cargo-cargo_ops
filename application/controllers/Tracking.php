...
class Tracking extends CI_Controller
{
	...
	public function Search($cn)
	{
		...
		if (!empty($shipment_data)) {
			...
			echo ("<a href='".base_url()."Booking/Booking/print_address_label1/" . $id . "' target='_blank' id='fixedbutton' class='btn ' style='border-radius:50px; color:white;margin-left: 10px; margin-top: -10px; margin-bottom: 10px; background: linear-gradient(to right, #23074d 0%, #cc5333 100%);'>Address Label</a>");

			//-------Load TabMenu----End--
			echo "<br><table class='table table-bordered table-inline table-responsive ' style='border:1px solid #8c363d' >";
			...
			echo "</table>";
			//-8-----Iframe-------------
			echo ("<div class='col-lg-7' style='background-color:#fff'> <iframe style='margin-left:1%' width='100%'  name='lact' frameborder='0' style='background-color:#fff' scrolling='no' src='" . base_url() . "Tracking/ShowLact/" . $id . "' id='iframe' onload='javascript:resizeIframe(this);' ></iframe></div>");
			//-------Iframe---------End--
