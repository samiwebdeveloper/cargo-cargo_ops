...
class Trackingo extends CI_Controller {
	...
	{
	$data['Shipment_id']=$cn;	
	$this->load->view('module_trackingo/HomeView',$data); 	
	}
	...
	//----Get Values-------End--	
	//echo ("<a href='https://tmdelex.com/Booking/print_address_label/".$id ."' target='_blank' id='fixedbutton' class='btn btn-primary'>Print Address Label</a>");
	//-------Load TabMenu----End--
	...
	//-------Line Three----End--
	//-5-----Line Four------
	$this->LineFour($cn,$product_detail,$cod_amount,$customer_name);
	//-------Line Four----End--
	//-7-----Line Six------
...
//}
	...
	echo "<tr>";
	echo "<td width=12% style='color:white;font-size:13px;background-image:linear-gradient(45deg, #1f3953, #a01c21);'><center>Shipper Name</center></td>";
	echo "<td width=13% bgcolor=#fff><center><code style='color:#1f3953;font-size:13px'>".$shipper_name."</code><center></td>";
	...
	echo "<td width=13% bgcolor=#fff><center><code style='color:#1f3953;font-size:13px'>".$consignee_name."</code></center></td>";
	echo "</tr>";
	}	
