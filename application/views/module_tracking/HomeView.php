    ...
    <div class="container_fluid">
        ...
        ?>
            ...
            <table class="table ">
                <tr bgcolor="#fff">
                    <td>
                        <center><input style="background-color:#fff;border:9px solid #009a66" type="number" name="animalid" id="animal_id" class="form-control" placeholder="Enter CN And Press Tab" onkeyup="return chkanimal(this.value);"></center>
                    </td>
                </tr>
            </table>
        ...
        <?php } else { ?>
            <table class="table" style="background-color:black ">
                <tr bgcolor="#fff">
                    <td>
                        <center> <input style="background-color:#fff;border:1px solid #009a66" onkeyup="return chkanimal(this.value);" placeholder="Track your shipment" type="number" name="animalid" id="animal_id" class="form-control">
                    </td>
                </tr>
            </table>
        <?php } ?>
        ...
        <div id="data-load" style="width:95%;margin-left:1%;font-size:14px"></div>
