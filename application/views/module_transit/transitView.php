                        ...
                        <tbody>
                          ...
                          if (!empty($loading_sheets)) {
                            ...
                            foreach ($loading_sheets as $rows) {
                              ...
                              echo ("
                              <td>
                               <a target='_blank'  href='" . base_url() . "Loading/loading_update/" . $rows->transit_list_id . "' class='btn btn-info btn-xs'>Update Status</a>
                               <a target='_blank' href='" . base_url() . "Loading/loading_print/" . $rows->transit_list_id . "' class='btn btn-info btn-xs'>Print</a>
                               <a target='_blank' href='" . base_url() . "Loading/loading_print_all/" . $rows->transit_list_id . "' class='btn btn-info btn-xs'>Print All</a>
                               <a  target='_blank' href='" . base_url() . "Loading/export_manifest_detail/" . $rows->transit_list_id . "' style='margin-left:3px;' class='btn btn-info btn-xs'>Excel</a>
                               </td>
                               ");
