...
<td style="width:60%;border-bottom: 1px solid black;font-size: 25px;"> <strong><?php echo $_SESSION['origin_name']." - ".$hub; ?></strong></th>
</tr>
<tr>
...
<table style='width:95%;margin-left:3px;margin-top:15px' border=1; id="myTable">
<tr>
