            ...
            <body style='margin-left:3px;border:1px'>
                ...
                <table style="width:95%;margin-left:3px">
                    <tr>
                        ...
                        <th style="width:10%">
                            <center>No. of Pieces</center>
                        </th>
                        <td style="width:5%;border-bottom: 1px solid black;">
                            <center><?php echo $tpieces; ?> </center>
                            </th>
                        <td style="width:2%">
                            </th>
                        <th style="width:10%">
                        ...
                        <td style="width:7%;border-bottom: 1px solid black;">
                            <center><?php echo $tweight; ?> KG </center>
                            </th>
                        <td style="width:2%">
                            </th>
                        <th style="width:10%">
                        ...
                        <td style="width:18%;border-bottom: 1px solid black;">
                            </th>
