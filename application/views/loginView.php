  ...
  <div class="login-wrapper " style="background-color:#6d5eac">
    ...
    <div class="bg-pic">
      ...
      <div class="bg-caption pull-bottom sm-pull-bottom text-white p-l-20 m-b-20">
        ...
        <p class="small">
          images Displayed are solely for representation purposes only, All work copyright of respective owner, otherwise © 2013-2014 SaimTech.
        </p>
      </div>
    ...
    <div class="login-container bg-white">
      <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
        <img src="<?php echo base_url(); ?>assets/img/tmlogo.png" alt="logo" data-src="<?php echo base_url(); ?>assets/img/tmlogo.png" data-src-retina="<?php echo base_url(); ?>assets/img/tmlogo.png" style=" margin-left:50px;" width="260" height="170">
