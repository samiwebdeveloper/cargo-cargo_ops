                  ...
                  <div class="card-body">
                      ...
                      <div class="row clearfix">
                        ...
                        <div class="col-md-3">
                          <div class="form-group form-group-default" aria-required="true" id="manual_cn_div">
                            ...
                            <input type="text" class="form-control" onblur="check_mcn();" name="manual_cn" id="manual_cn" tabindex="2" aria-required="true">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group form-group-default required" aria-required="true" id="order_date_div">
                            <label>Booking Date</label>
                            <input type="date" class="form-control" name="order_date" id="order_date" tabindex="3" value="<?php echo date('Y-m-d'); ?>" readonly="">
                          </div>
                        </div>
                        <div class="col-md-3">
                      ...
                      <div class="row clearfix">
                        ...
                        <div class="col-md-3">
                          <div class="form-group form-group-default" id="s_phone_div">
                            ...
                            <input type="text" class="form-control" name="s_phone" id="s_phone" required="" tabindex="6">
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group form-group-default" id="s_email_div">
                            <label>Consignor Email</label>
                            <input type="email" class="form-control email" value="test@test.com" name="s_email" id="s_email" tabindex="7" autocomplete="on">
                          </div>
                        </div>
                      </div>
                      <div class="row clearfix">
                    ...
                    <div class="form-group-attached">
                      <div class="row clearfix">
                        ...
                        <div class="col-md-2">
                          <div class="form-group form-group-default required" id="recheck_weight_div">
                            <label>Recheck Weight</label>
                            <select class='form-control' name="recheck_weight" id="recheck_weight" tabindex="">
                      ...
                      <div class="row clearfix" id="result_div">
                        <div class="col-md-4" id="cod_div_div">
                          <div class="form-group form-group-default required" id="cod_div">
                            <label>FOD/CASH</label>
                            <input type="number" class="form-control" name="cod" id="cod" autocomplete="on" tabindex="20">
                          </div>
                        </div>
                        <div class="col-md-8" id="remark_div_div">
                          <div class="form-group form-group-default" id="remark_div">
                            <label>Description</label>
                            <input type="text" class="form-control" value="N/A" name="remark" id="remark" autocomplete="on" tabindex="21">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group-attached">
                      <div class="row clearfix">
                        <button class="btn btn-info" onclick="add_shipment()" tabindex="22">Book Shipment</button>
...
<script type="text/javascript">
        ...
        success: function(data) {
          if (data != "") {
            ...
            if (myArr.service_type == "1") {
              ...
              $("#service_type_div").html(uhtml);
            } else if (myArr.service_type == "14") {
              uhtml = "<label>Service Type</label><select class='form-control' name='service_type' id='service_type' tabindex='16'><option value='1'>Over Night</option><option value='2'>Over Land</option><option value='4'>Air Frieght</option></select>";
              $("#service_type_div").html(uhtml);
            }
  ...
  function add_shipment() {
    ...
    //--------------------------------End
    //---------Recheck Weight--------------
    if ($("#recheck_weight").val() != "") {
      recheck_weight = $("#recheck_weight").val();
      $("#recheck_weight").css("border-color", "rgba(0, 0, 0, 0.07)");
    } else {
      $("#recheck_weight_div").css("border-color", "red");
      $("#recheck_weight").focus();
      check = "Fail";
    }
    //--------------------------------End
    //---------Manaul_cn--------------
