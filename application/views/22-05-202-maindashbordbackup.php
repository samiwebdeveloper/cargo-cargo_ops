    ...
    <div class="content">
        ...
        <div class="container-fluid container-fixed-lg">
            ...
            <div class="row">
                                            ...
                                            <div class="card mt-4 mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="chart-container pie-chart" id="chart1">
                                                        <!-- <canvas height="340" id="origin_city_name"></canvas> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mt-4 mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="chart-container pie-chart" id="chart2">
                                                        <!-- <canvas id="city_destination_wise" height="340"></canvas> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mt-4 mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="chart-container pie-chart" id="chart3">
                                                        <!-- <canvas id="weight_on_route_30days" height="340"></canvas> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mt-4 mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="chart-container pie-chart" id="chart4">
                                                        <!-- <canvas id="booking_on_route_30days" height="340"></canvas> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card mt-4 mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="chart-container pie-chart" id="chart5">
                                                        <!-- <canvas id="not_delivered" height="340"></canvas> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="card mt-4 mb-7">
                                                <div class="card-header">Order Not Delivered Destination City Wise</div>
                                                <div class="card-body">
                                                    <div class="chart-container pie-chart">
                                            ...
                                            <div class="card mt-4 mb-4">
                                                ...
                                                <div class="card-body">
                                                    <div class="chart-container pie-chart" id="chart10">
                                                        <!-- <canvas id="not_manifested" height="340"></canvas> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-md-8">
                    <div class="card mt-4 mb-4">
                        <div class="card-header">Booking Wieght,Pieces and Order Wise</div>
                        <div class="card-body">
                    ...
                    <div class="card mt-4 mb-4">
                        ...
                        <div class="card-body">
                            <div class="chart-container pie-chart" id="chart6">
                                <!-- <canvas id="service_name" height="340"></canvas> -->
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mt-4 mb-4">
                        <div class="card-header">Order Status Wise</div>
                        <div class="card-body">
                            <div class="chart-container pie-chart" id="chart7">
                                <!-- <canvas id="booking_status" height="340"></canvas> -->
                            </div>
                        </div>
                    </div>
                </div>
         ...
         $('#chart1').html('<canvas id="origin_city_name" height="340"></canvas>');
            $.ajax({
                ...
                success: function(data) {
                    ...
                    console.log(origin_city_name+"1");
                    var Total = [];
                    var color = [];
                    for (var count = 0; count < data.length; count++) {
                    ...
                    console.log(origin_city_name+"2");
                    var chart_data = {
