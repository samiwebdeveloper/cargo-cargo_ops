	...
	class Home extends CI_Controller
	{
		...
		public function index()
		{
			...
			if($root=="https"){ 
				...
				header('Location: https://stage.tmcargoexpress.com/ops_tm/Home');   
		...
		public function submit_admin_qsr()
		{
			...
			if ($start_date != "" && $end_date != "" && $customer != "") {
				...
				$all_data = array_merge($qsr_data, $qsr_archive_data);				
				$x = 1;
