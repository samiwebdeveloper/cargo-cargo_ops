    ...
    <div class="container-fluid container-fixed-lg">
      ...
      <div class="row">
        ...
        <div class="col-md-4 m-b-10">
          <div id="piechart1" style="width:100%; max-width:600px; height:350px;"></div>
        </div>
        <div class="col-md-4 m-b-10">
          <div id="myChart" style="width:100%; max-width:600px; height:350px;"></div>
        </div>
        <div class="col-md-4 m-b-10">
         
          <div id="barchart_material" style="width:100%; max-width:600px; height:350px;"></div>
...
<script type="text/javascript">
      ...
      var options = { chart: { title: 'Booking Date Wise',subtitle: 'Booking Date,Booking, Weight, Pieces',},
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        <?php foreach ($city_booking_wise as $key => $val) { ?>['<?php echo $val['origin_city_name'] ?>', <?php echo $val['origin_city'] ?>],
        <?php } ?>
      ]);
      var options = {
        title: 'Booking Origion_City Wise',
        is3D: true,
        display: true
      };
