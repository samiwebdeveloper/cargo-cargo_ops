...
!(function(t, e) {
    ...
    function M(t, e, i) {
        ...
        let n;
        for (
            e + i > 1 && ((n = 1 / (e + i)), (e *= n), (i *= n)), n = 0; n < 3; n++
        )
            (s[n] *= 1 - e - i), (s[n] += e);
        return s;
    }
            ...
            (function(t) {
                ...
                if (e) {
                    ...
                    return (
                        ...
                        (i = 255 & (e[2] ? p(i) : i)),
                        (s = 255 & (e[4] ? p(s) : s)),
                        (n = 255 & (e[6] ? p(n) : n)), { r: i, g: s, b: n, a: o }
                    );
                }
            })(t) :
            C(t);
    ...
    var ni = {
        ...
        update(t, e, i, s) {
            ...
            const c =
                ...
                u = Object.assign({}, n);
            Je(u, Ne(s));
            const f = Object.assign({ maxPadding: u, w: o, h: a, x: n.left, y: n.top },
                    n
                ),
                g = Ge(l.concat(h), d);
            ei(r.fullSize, f, d, g),
    ...
    function Vi(t, e, i) {
        ...
        a = e.length, { compare: r, between: l, normalize: h } = Fi(s), {
                start: c,
                end: d,
                loop: u,
                style: f,
            } = (function(t, e, i) {
                const { property: s, start: n, end: o } = i, { between: a, normalize: r } = Fi(s),
                    l = e.length;
                let h,
                    c, { start: d, end: u, loop: f } = t;
                if (f) {
                    for (
                        d += l, u += l, h = 0, c = l; h < c && a(r(e[d % l][s]), n, o);
                        ++h
                    )
                        d--, u--;
                    (d %= l), (u %= l);
    ...
    class Ui {
        ...
        getMaximumSize(t, e, i, s) {
            return (
                ...
                (i = i || t.height), { width: e, height: Math.max(0, s ? Math.floor(e / s) : i) }
            );
        }
        isAttached(t) {
            return !0;
    ...
    class Ps {
        ...
        parse(t, e) {
            const { _cachedMeta: i, _data: s } = this, { iScale: n, _stacked: o } = i,
            a = n.axis;
            let r,
                l,
                h,
        ...
        getMinMax(t, e) {
            ...
            for (
                d = 0; d < o && (f() || (this.updateRangeFromParsed(l, t, u, r), !n));
                ++d
            );
            if (n)
                for (d = o - 1; d >= 0; --d)
            ...
            this.update(t || "default"),
                (e._clip = (function(t) {
                    ...
                    return (
                        ...
                        (e = i = s = n = t), { top: e, right: i, bottom: s, left: n, disabled: !1 === t }
                    );
                })(
                    K(
                        this.options.clip,
    ...
    function Ts(t, e, i, s, n) {
        ...
        let r,
            ...
            c = 0;
        for (
            i = Math.ceil(i), n && ((r = n - s), (i = r / Math.floor(r / i))), h = o; h < 0;
    ...
    class Bs extends Ds {
        ...
        getUserBounds() {
            ...
            return (
                ...
                (s = q(s, Number.NEGATIVE_INFINITY)), { min: q(t, i), max: q(e, s), minDefined: X(t), maxDefined: X(e) }
            );
        }
        getMinMax(t) {
            ...
            return (
                (i = o && i > s ? s : i),
                (s = n && i > s ? i : s), { min: q(i, q(s, i)), max: q(s, q(i, s)) }
            );
        }
        getPadding() {
            return {
    ...
    class dn {
        ...
        buildOrUpdateControllers() {
            ...
            let i, s;
            for (
                this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++
            ) {
                const s = e[i];
        ...
        update(t) {
            ...
            if (
                (this._updateScales(),
                    ...
                    this._plugins.invalidate(), !1 === this.notifyPlugins("beforeUpdate", { mode: t, cancelable: !0 }))
            )
                return;
        ...
        _stop() {
            let t, e;
            for (
                this.stop(), a.remove(this), t = 0, e = this.data.datasets.length; t < e;
                ++t
            )
    ...
    function vn(t, e, i, s) {
        ...
        const {
            ...
            return (
                ...
                e ? ((n = "end"), (o = "start")) : ((n = "start"), (o = "end")), { start: i, end: s, reverse: e, top: n, bottom: o }
            );
        })(t);
        "middle" === n &&
            i &&
                    ...
                    (function(t, e, i, s) {
                        ...
                        return (
                            ...
                            ((o = e.min * i.categoryPercentage),
                                (a = i.barPercentage)) :
                            ((o = n * s), (a = 1)), { chunk: o / s, ratio: a, start: e.pixels[t] - o / 2 }
                        );
                    })(t, e, s, i),
    ...
    function Bn(t, e, i, s, n) {
        const { options: o } = e, { borderWidth: a, borderJoinStyle: r } = o,
    ...
    function jn(t, e, i, s) {
        const { points: n, options: o } = e, { count: a, start: r, loop: l, ilen: h } = Hn(n, i, s),
            c = (function(t) {
                return t.stepped ?
                    ee :
    ...
    function Zn(t, e) {
        ...
        return (
            ...
            ((d = o / 2),
                ...
                (l = i + d),
                (h = Math.min(s, n)),
                (c = Math.max(s, n))), { left: r, top: h, right: l, bottom: c }
        );
    }
            ...
            t.data.datasets.forEach((e, n) => {
                ...
                let { start: c, count: d } = (function(t, e) {
                    ...
                    return (
                        ...
                        (s = h ? jt(re(e, o.axis, r).hi + 1, n, i) - n : i - n), { start: n, count: s }
                    );
                })(r, l);
    ...
    function lo(t, e, i) {
        const s = (function(t) {
            ...
            return (
                void 0 === s && (s = !!e.backgroundColor), !1 !== s && null !== s && (!0 === s ? "origin" : s)
            );
        })(t);
    ...
    function _o(t, e, i, s) {
        ...
        let n = e[t],
            o = i[t];
        return (
            "angle" === t && ((n = Nt(n)), (o = Nt(o))), { property: t, start: n, end: o }
        );
    }
    ...
    const Po = (t, e) => {
        ...
        return (
            t.usePointStyle && ((i = Math.min(i, e)), (s = Math.min(s, e))), { boxWidth: s, boxHeight: i, itemHeight: Math.max(e, i) }
        );
    };
    class Do extends Ds {
        constructor(t) {
        ...
        _draw() {
            const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this, { align: a, labels: r } = t,
            l = bt.color,
                h = Ei(t.rtl, this.left, this.width),
                c = He(r.font), { color: d, padding: u } = r,
                f = c.size,
                g = f / 2;
            let p;
            this.drawTitle(),
        ...
        _drawArgs(t) {
            ...
            return (
                ...
                ("left" === a.position ?
                    ...
                    (l = s - e)), { titleX: h, titleY: c, maxWidth: l, rotation: d }
            );
        }
        draw() {
            const t = this.ctx,
    ...
    function Wo(t, e, i, s) {
        ...
        return (
            ...
            "left" === r ?
            (g -= Math.max(c, u) + n) :
            "right" === r && (g += Math.max(d, f) + n), { x: jt(g, 0, s.width - e.width), y: jt(p, 0, s.height - e.height) }
        );
    }
        ...
        getCaretPosition(t, e, i) {
            ...
            return (
                ...
                ((m =
                    ...
                    (y = b)), { x1: p, x2: m, x3: x, y1: b, y2: _, y3: y }
            );
        }
        drawTitle(t, e, i) {
            const s = this.title,
    ...
    function ia(t) {
        ...
        for (let d = 0; d < o; d++) {
            ...
            const u = t.getPointPosition(d, t.drawingArea + n[d], r),
                ...
                ((l = t.ctx),
                    (h = f),
                    (c = Y((c = t._pointLabels[d])) ? c : [c]), { w: qt(l, h.string, c), h: c.length * h.lineHeight });
            s[d] = g;
